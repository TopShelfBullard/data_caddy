...
driver = Club.create!(name: "Driver", position: 1)
one_wood = Club.create!(name: "1 Wood", position: 2)
three_wood = Club.create!(name: "3 Wood", position: 3)
five_wood = Club.create!(name: "5 Wood", position: 4)
three_iron = Club.create!(name: "3 Iron", position: 5)
four_iron = Club.create!(name: "4 Iron", position: 6)
five_iron = Club.create!(name: "5 Iron", position: 7)
six_iron = Club.create!(name: "6 Iron", position: 8)
seven_iron = Club.create!(name: "7 Iron", position: 9)
eight_iron = Club.create!(name: "8 Iron", position: 10)
nine_iron = Club.create!(name: "9 Iron", position: 11)
pitching_wedge = Club.create!(name: "Pitching Wedge", position: 12)
sand_wedge = Club.create!(name: "Sand Wedge", position: 13)
trouble_wedge = Club.create!(name: "Trouble Wedge", position: 14)
putter = Club.create!(name: "Putter", position: 15)
